...
namespace RSASupportAPI.RSASupportBLL
{
    public interface IClientService
    {
      Task<Client> GetClients();
       Task<List<dynamic>> GetClientData(string clientName, string selectQuery);
        ...
        Task<List<LMRewards>> GetLMReward(string clientName);
  ...
  Task<DeleteUserRequest> DeleteUser(string clientName, DeleteUserRequest deleteUserRequest);
        ...
        Task<FindShopperPagination> GetFilteredUserDetails(string clientName, int? page, int? limit, string? sortColumn, string? sortDirection, string? searchTerm);

        //Task<List<dynamic>> GetLMReward(string clientName, string selectQuery);
        //  Task<UserDetails> GetClientData(string clientName, string selectQuery);
        //  Task<Dictionary<string, object>> GetClientData(string clientName, string selectQuery);
        // Task<dynamic> GetClientData(string clientName, string selectQuery);
